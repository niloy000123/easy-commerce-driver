              ...
              ? SizedBox(
                  ...
                  child: CircularProgressIndicator(
                    valueColor: AlwaysStoppedAnimation<Color>(
                      loaderColor ?? context.color.surface,
                    ),
                  ),
                )
              : Row(
                  ...
                  children: [
                    ...
                    Text(
                      title,
                      style: textStyle.s14w500Title.copyWith(
                        color: titleColor ?? AppStaticColor.whiteColor,
                      ),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                    ),
                    if (prefixIcon != null) 8.pw,
              ...
              : Row(
                  ...
                  children: [
                    ...
                    Text(
                      title,
                      style: textStyle.s14w500Title.copyWith(
                        color: titleColor ?? AppStaticColor.primaryColor,
                      ),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                    ),
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Text(
              title,
              style: textStyle.s12w400Body.copyWith(
